...
module vga_console(
  ...
  output reg [11:0] text_rgb,  //output color  12 bit
...
//  wire cursor_on;
  ...
  wire [11:0] font_rgb;      //color for text
  wire [11:0] font_inv_rgb;  //color for text with cursor on top
  ...
  //Color Generation
  assign font_rgb = (font_bit) ? 12'b000011110000 : 12'b000000000000; //green:black
  assign font_inv_rgb = (font_bit) ? 12'b0000000 : 12'b000011110000; //black:green
